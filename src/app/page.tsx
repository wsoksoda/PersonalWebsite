...
export default function Home() {
    ...
    return (
        <ChakraProvider>
            ...
            <Box bgColor={"black"} height={"100vh"} ref={scrollToWork}>

                <Grid templateColumns='repeat(2,1fr)' templateRows='repeat(2, 1fr)' gap={20} mb={20} mx={20} pt={20}>
                    <GridItem colSpan={1}>
                    ...
                    <GridItem colSpan={1}>
                        <Text color='white'>
                            ...
                            through a
                            pageable
                            website displaying all of them. Learn more about a specific set through the info button or
                            search
                            for your favorite
                            set.
                        </Text>
                    ...
                    <GridItem colSpan={1}>
                        <Text color='white'>
                            A Full Stack project complete with a Spring Boot, Kotlin Backend and a NextJS frontend.
                            This project allows you to create, edit, and view workouts. Personalize your plan to what
                            you
            ...
            <Box bgColor={"black"} height={"100vh"} ref={scrollToSocials}>
